...
void new_vec_experiment() {
  ...
  std::cout << "insertion: Total time in nanoseconds: " << duration.count()
            << std::endl;
  std::cout << "insertion: Average time in nanoseconds: "
            << (double)duration.count() / (double)total_insertions << std::endl;
  ...
  std::cout << "lookup: Total time in nanoseconds: " << duration.count()
            << std::endl;
  std::cout << "lookup: Average time in nanoseconds: "
            << (double)duration.count() / (double)total_insertions << std::endl;
